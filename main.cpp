...
int main(int argc, const char *argv[]) {
	...
	try {
		rpos::core::Location location1=rpos::core::Location(2,1);
		...
		options.flag = rpos::features::motion_planner::MoveOptionFlag(MoveOptionFlagMilestone | MoveOptionFlagPrecise);
